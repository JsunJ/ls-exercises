// Write a function that takes a word and some text as arguments, and returns
// the text with every instance of the word highlighted. To highlight a word,
// enclose the word with two asterisks ('**') on each side and change every
